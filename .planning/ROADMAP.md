...
- [x] 03.1-02-PLAN.md — Primitives: npx shadcn add chart slider avatar + Badge filter-chip variant + metrics/{Sparkline, Delta, LogoTile} + neutral-scrub audit + 5 unit tests (wave 2)
